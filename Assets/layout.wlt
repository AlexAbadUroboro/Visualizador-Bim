...
MonoBehaviour:
  ...
  m_LastProjectPath: /Users/raoul.dewhurst/Downloads/Unity Asset Transformer Tutorial_final
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 106}
    m_SelectedIDs: 84af0000
    m_LastClickedID: 44932
    m_ExpandedIDs: 0000000082af000084af000000ca9a3b
    m_RenameOverlay:
  ...
  m_AssetTreeState:
    ...
    m_CreateAssetUtility:
      ...
      m_ResourceFile: 
  m_ListAreaState:
    m_SelectedInstanceIDs: eead0000
    m_LastClickedInstanceID: 44526
    m_HadKeyboardFocusLastEvent: 0
    m_ExpandedInstanceIDs: c6230000bed60000142e0100
    m_RenameOverlay:
      m_UserAcceptedRename: 0
      m_Name: 
      m_OriginalName: 
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      scrollPos: {x: 0, y: 0}
      m_SelectedIDs: eead0000
      m_LastClickedID: 0
      m_ExpandedIDs: 32f6ffff4af6ffff20fbffff
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      id: Tool Settings
      index: 0
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-160.0,"y":-26.66668701171875},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
    ...
    - dockPosition: 0
      ...
      index: 1
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-141.0,"y":-191.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -141, y: -191}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":67.5,"y":-55.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 67.5, y: -55}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 1
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-182.0,"y":-172.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 1
      snapOffset: {x: -182, y: -172}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 8
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-254.0,"y":-210.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -254, y: -210}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      displayed: 0
      id: UnityEditor.PixyzPlugin4Unity.StatisticsOverlay
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":739.9990234375,"y":424.9990234375},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: 739.999, y: 424.99902}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 0
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      containerId: Floating
      displayed: 0
      id: UnityEditor.PixyzPlugin4Unity.Toolbox.ToolboxOverlay
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":348.3323974609375,"y":-212.66665649414063},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: 348.3324, y: -212.66666}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    m_Target: {x: 6.8765597, y: 0.91237307, z: -2.8564343}
    speed: 2
    m_Value: {x: 6.8765597, y: 0.91237307, z: -2.8564343}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0.11036403, y: 0.6900061, z: -0.10768024, w: -0.70719415}
    speed: 2
    m_Value: {x: -0.11036403, y: 0.69000614, z: -0.10768024, w: -0.70719415}
  m_Size:
    m_Target: 1.4909533
    speed: 2
    m_Value: 1.4909533
  ...
  m_LastSceneViewRotation: {x: -0.04631559, y: 0.7773249, z: -0.05762737, w: -0.62474537}
  ...
  m_LastDebugDrawMode:
    drawMode: -2147483648
    name: Show back-faces
    section: Asset Transformer
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_DrawArea:
      ...
      width: 964.6666
      height: 515
    m_Scale: {x: 0.23842593, y: 0.23842593}
    m_Translation: {x: 482.3333, y: 257.5}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 2160
    m_MinimalGUI: 1
  m_defaultScale: 0.23842593
  m_LastWindowPixelSize: {x: 964.6666, y: 536}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
